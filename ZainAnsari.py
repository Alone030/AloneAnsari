...
logo = """
   Asif Javed
   ▄︻̷̿┻̿═━一
   THE ANONYMOUS ZainAnsari TRICKER 
   THE LEGEND ℒℴνℯ
...
\033[1;96mGitHub  \033[1;93m: \033[1;92mhttps://github.com/ZainAnsari/love
\033[1;96mBlogger \033[1;93m: \033[1;92mhttps://www.facebook.com/Tɘʀʌ Dɩwʌŋʌ ʜʋŋ Ƴwɘʀ
\033[1;91m======================================="""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
\033[1;91m======================================="""
print " \x1b[1;93m============================================================="
CorrectUsername = "ŴħÏ†㉫㉫vÏし"
CorrectPassword = "03091870635"
loop = 'true'
while (loop == 'true'):
